...
function Register($user_type, $username, $password, $conn, $email, $date)
{
    if ($username && $email) {
        ...
        if (!$result_check2 > 0) {
            ...
            echo "<div class='error-styler'><center>
            <p style='padding: 10px; margin: 10px; font-size: 14px; color: #fff; font-weight: 600; border-radius: 8px; text-align: center; background: #ff7474;'>Account Already Exists!</p>;
            </center></div>";
        }
    } else {
        echo "<div class='error-styler'><center>
